...
using ProductReviewManagement;
    ...
    List<ProductReview> productReviewList = new List<ProductReview>()
    {
        ...
        new ProductReview(){ProductId = 2, UserId = 5, Rating = 8, Review = "Bad", IsLike = false },
        new ProductReview(){ProductId = 6, UserId = 6, Rating = 7, Review = "Nice", IsLike = true},
        new ProductReview(){ProductId = 1, UserId = 7, Rating = 5, Review = "Nice", IsLike = true},
        ...
        new ProductReview(){ProductId = 1, UserId = 12, Rating = 1, Review = "Nice", IsLike = true},
        ...
        new ProductReview(){ProductId = 6, UserId = 16, Rating = 5, Review = "Nice", IsLike = true},
        ...
        new ProductReview(){ProductId = 9, UserId = 19, Rating = 5, Review = "Good", IsLike = true},
        ...
        new ProductReview(){ProductId = 2, UserId = 22, Rating = 5, Review = "Good", IsLike = true},
